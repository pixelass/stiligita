...
var Header = _src2.default.header(_templateObject2, function (_) {
  return _.active ? '#fe9f2e' : '#63e2bb';
}, function (_) {
  return _.active ? '#ae6f22' : '#49a489';
}, spin, function (_) {
...
var _abcq = __webpack_require__(29);
...
var _htmlElementAttributes = __webpack_require__(35);
...
var _domElements = __webpack_require__(37);
...
var stylis = new _stylis2.default({ keyframe: false, compress: false });
...
var createStyleBlock = function createStyleBlock(s, k) {
  var styles = Object.keys(s).map(function (key) {
    return stylis('.' + key, s[key]);
  }).join('');
  var keyframes = Object.keys(k).map(function (key) {
...
var notListener = function notListener(_) {
  var _ref = _slicedToArray(_, 3),
      o = _ref[0],
      n = _ref[1],
      C = _ref[2];
...
var createCSS = function createCSS(strings, args, props) {
...
var starAttributes = _htmlElementAttributes2.default['*'];

var Stiligita = function (_Component) {
  _inherits(Stiligita, _Component);

  function Stiligita(props) {
    _classCallCheck(this, Stiligita);

    var _this = _possibleConstructorReturn(this, (Stiligita.__proto__ || Object.getPrototypeOf(Stiligita)).call(this, props));
  ...
  _createClass(Stiligita, [{
    ...
    key: 'cleanUp',
    value: function cleanUp(props) {
      var elementAttributes = _htmlElementAttributes2.default[props.domElement] || [];
      var validAttributes = [].concat(_toConsumableArray(starAttributes), _toConsumableArray(elementAttributes), ['children']);
      this.setState({
        removeAttrs: Object.keys(props).filter(function (_) {
          return validAttributes.indexOf(_) < 0 && notListener(_);
        })
      });
    }
  }, {
    key: 'render',
    value: function render() {
      var removeAttrs = this.state.removeAttrs;

      var props = (0, _lodash2.default)(this.props, removeAttrs);
      return (0, _react.createElement)(this.props.domElement, _extends({}, props, { className: this.props.className }));
    }
  }]);
...
var createComponent = function createComponent(args, _ref2) {
  ...
  return function () {
    ...
    var pp = filterObject((0, _lodash2.default)(p, ['children']));
    var pString = JSON.stringify(pp);
    var css = createCSS(strings, args, p);
    ...
    return _react2.default.createElement(Stiligita, _extends({}, p, { className: className, domElement: domElement }));
  };
};
...
var Keyframes = exports.Keyframes = function Keyframes() {
  ...
  args.shift();
  var id = createClassName((0, _v2.default)(), '');
